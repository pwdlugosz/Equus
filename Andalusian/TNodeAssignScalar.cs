...
namespace Equus.Andalusian
{
    ...
    /// </summary>
    public sealed class TNodeAssignScalar : TNode
    {

        private FNode _Mapping;
        private int _Index;
        ...
        {
            return new TNodeAssignScalar(this.Parent, this._Heap, this._Index, this._Mapping.CloneOfMe(), this._AssignID);
        }
