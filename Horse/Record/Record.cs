...
namespace Equus.Horse
{
    ...
    /// </summary>
    public class Record : IComparer<Record>, IComparable<Record>, IEqualityComparer<Record>, IEquatable<Record>
    {
        ...
        /// <summary>
        /// Gets the sum of Cell.Size values for the record
        /// </summary>
        internal int Size
        {
            get
            {
                return this._data.Sum((x) => { return x.Size; });
            }
        }
        ...
        /// </summary>
        /// <param name="R">A record to compare to the current instance</param>
        /// <returns>An integer representing the compare</returns>
        int IComparable<Record>.CompareTo(Record R)
        {
            return Record.Compare(this, R);
        }

        /// <summary>
        /// Compares two records
        /// </summary>
        /// <param name="A">The left record</param>
        /// <param name="B">The right record</param>
        /// <returns>An integer comparision value</returns>
        ...
        /// <summary>
        /// Checks if all values in two records are equal
        /// </summary>
        /// <param name="A">The first record</param>
        /// <param name="B">The second record</param>
        /// <returns>A boolean comparison</returns>
        bool IEqualityComparer<Record>.Equals(Record A, Record B)
        {
            return Record.Compare(A, B) == 0;
        }

        /// <summary>
        /// Gets the hashcode of a given record
        /// </summary>
        /// <param name="A">A record to digest</param>
        /// <returns>An integer hash code</returns>
        int IEqualityComparer<Record>.GetHashCode(Record A)
        {
            return A.GetHashCode();
        }

        /// <summary>
        /// Checks if a given record's values are equal to the current instance
        /// </summary>
        /// <param name="A">A record to compare</param>
        /// <returns>A boolean</returns>
        bool IEquatable<Record>.Equals(Record A)
        {
            return Record.Compare(this, A) == 0;
        }
